...
1. **Proceed to planning** - Run `/plan_w_team`
...
When brainstorm output exists, `/plan_w_team` should detect it and use it as input, skipping its own idea refinement phase.
